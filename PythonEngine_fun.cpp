...
static PyObject *tibiaauto_reader_readSelfCharacter(PyObject *self, PyObject *args)
{
	...
	char buf[11111];
	sprintf(buf,"%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %f-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %s-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d-%s %d",
		"hp",selfCh->hp,
		"mana",selfCh->mana,
		"x",selfCh->x,
		"y",selfCh->y,
