...
bool AddressFinder::getFlagsComp() 
{
	...
	Mask.push_back(1);
	Comparison.push_back(0x10);
	Mask.push_back(1);
	Comparison.push_back(0x27);
	Mask.push_back(1);
	Comparison.push_back(0x0);
	Mask.push_back(1);
	Comparison.push_back(0x0);
	...
	Comparison.push_back(0x7d);
	Mask.push_back(1);
	Comparison.push_back(0xf);
	Mask.push_back(1);
	Comparison.push_back(0x8d);
	Mask.push_back(1);
	Comparison.push_back(0xc);
	Mask.push_back(1);
	Comparison.push_back(0x80);
	Mask.push_back(1);
	Comparison.push_back(0xc1);
	Mask.push_back(1);
	Comparison.push_back(0xe1);
	Mask.push_back(1);
	Comparison.push_back(0x5);
	Mask.push_back(1);
	Comparison.push_back(0x89);
	Mask.push_back(1);
