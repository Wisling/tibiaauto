...
#if (defined __WIN32__ || defined _WIN32) && defined BUILD_LIBXTRE_DLL
#	ifndef __GNUC__
...
#	define LIBXTRE_DLL_IMPEXP     __DLL_EXPORT__
	LIBXTRE_DLL_IMPEXP void *xmalloc_impl(size_t size, const char *file, int line, const char *func);
	LIBXTRE_DLL_IMPEXP void *xcalloc_impl(size_t nmemb, size_t size, const char *file, int line,
		   const char *func);
	LIBXTRE_DLL_IMPEXP void xfree_impl(void *ptr, const char *file, int line, const char *func);
	LIBXTRE_DLL_IMPEXP void *xrealloc_impl(void *ptr, size_t new_size, const char *file, int line,
		    const char *func);
	LIBXTRE_DLL_IMPEXP int xmalloc_dump_leaks(void);
	LIBXTRE_DLL_IMPEXP void xmalloc_configure(int fail_after);
#endif
