...
ON_BN_DOUBLECLICKED(IDC_ADDSPELLTOLIST, OnAddspelltolist)
ON_BN_CLICKED(IDC_LOADSPELLFROMLIST, OnLoadspellfromlist)
ON_BN_DOUBLECLICKED(IDC_LOADSPELLFROMLIST, OnLoadspellfromlist)
ON_BN_CLICKED(IDC_DELETEFROMLIST, OnDeletefromlist)
ON_BN_DOUBLECLICKED(IDC_DELETEFROMLIST, OnDeletefromlist)
